...
// > ```
    shared int
//  ^^^^^^ definition 0.1.test `sg/pr95`/ConflictingFields#$anon_d1af4e2f805ad8d3#shared.
//  documentation
//  > ```go
...
//         ^^^^^^ reference 0.1.test `sg/pr95`/ConflictingFields#$anon_d1af4e2f805ad8d3#shared.
   c.second.shared = 2
// ^ reference local 0
...
//    > ```
    field int
//  ^^^^^ definition 0.1.test `sg/pr95`/MultiNameConflict#$anon_e321dc9fd144ce2f#field.
//  documentation
//  > ```go
...
//     ^^^^^ reference 0.1.test `sg/pr95`/MultiNameConflict#$anon_e321dc9fd144ce2f#field.
   m.y.field = 20
// ^ reference local 1
