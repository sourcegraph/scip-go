...
//     ^^^^^^^^^^^^^ definition sg/testdata/TestInterface#
//     documentation ```go
...
// ^^ definition sg/testdata/TestInterface#Do.
// documentation ```go
//    ^^^ definition local 0
//        ^^^^^^^ reference github.com/golang/go/src context/
...
//                                       ^^^^^ definition local 2
  ...
  type (
   ...
   TestStruct struct {
// ^^^^^^^^^^ definition sg/testdata/TestStruct#
// documentation ```go
// documentation ```go
    // SimpleA docs
    SimpleA int
//  ^^^^^^^ definition sg/testdata/TestStruct#SimpleA.
//  documentation ```go
    // SimpleB docs
    SimpleB int
//  ^^^^^^^ definition sg/testdata/TestStruct#SimpleB.
//  documentation ```go
    // SimpleC docs
    SimpleC int
//  ^^^^^^^ definition sg/testdata/TestStruct#SimpleC.
//  documentation ```go
  
    FieldWithTag           string `json:"tag"`
//  ^^^^^^^^^^^^ definition sg/testdata/TestStruct#FieldWithTag.
//  documentation ```go
    FieldWithAnonymousType struct {
//  ^^^^^^^^^^^^^^^^^^^^^^ definition sg/testdata/TestStruct#FieldWithAnonymousType.
//  documentation ```go
     NestedA string
//   ^^^^^^^ definition sg/testdata/TestStruct#FieldWithAnonymousType.NestedA.
//   documentation ```go
     NestedB string
//   ^^^^^^^ definition sg/testdata/TestStruct#FieldWithAnonymousType.NestedB.
//   documentation ```go
     // NestedC docs
     NestedC string
//   ^^^^^^^ definition sg/testdata/TestStruct#FieldWithAnonymousType.NestedC.
//   documentation ```go
    }
  
    EmptyStructField struct{}
//  ^^^^^^^^^^^^^^^^ definition sg/testdata/TestStruct#EmptyStructField.
//  documentation ```go
   }
  
   TestEmptyStruct struct{}
// ^^^^^^^^^^^^^^^ definition sg/testdata/TestEmptyStruct#
// documentation ```go
// documentation ```go
  )
...
//      ^^^^^^^^^ definition ConstMath.
//      documentation ```go
  
  type StringAlias string
//     ^^^^^^^^^^^ definition sg/testdata/StringAlias#
//     documentation ```go
  
  const AliasedString StringAlias = "foobar"
//      ^^^^^^^^^^^^^ definition AliasedString.
//      documentation ```go
//                    ^^^^^^^^^^^ reference sg/testdata/StringAlias#
...
//      ^^ definition local 3
//          ^^^^^^^^^^ reference sg/testdata/TestStruct#
//                      ^^^^ definition sg/testdata/TestStruct#Doer().
//                      documentation ```go
...
//     ^^^^^^^^^^^^^^^^^^^ definition sg/testdata/StructTagRegression#
//     documentation ```go
//     documentation StructTagRegression is a struct that caused panic in the wild. Added here to
//     documentation ```go
   Value int `key:",range=[:}"`
// ^^^^^ definition sg/testdata/StructTagRegression#Value.
// documentation ```go
  }
  
  type TestEqualsStruct = struct {
//     ^^^^^^^^^^^^^^^^ definition sg/testdata/TestEqualsStruct#
//     documentation ```go
//     documentation ```go
   Value int
// ^^^^^ definition sg/testdata/TestEqualsStruct#Value.
// documentation ```go
  }
  
  type ShellStruct struct {
//     ^^^^^^^^^^^ definition sg/testdata/ShellStruct#
//     documentation ```go
//     documentation ```go
   ...
   // tests.
   InnerStruct
// ^^^^^^^^^^^ definition sg/testdata/ShellStruct#InnerStruct.
// documentation ```go
// documentation Ensure this field comes before the definition
// ^^^^^^^^^^^ reference sg/testdata/InnerStruct#
  }
  
  type InnerStruct struct{}
//     ^^^^^^^^^^^ definition sg/testdata/InnerStruct#
//     documentation ```go
//     documentation ```go
