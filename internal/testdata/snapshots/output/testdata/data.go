...
//      documentation ```go
//                    ^^^^^^ reference 0.1.test sg/testdata/internal/secret/
//                           ^^^^^^^^^^^ reference 0.1.test SecretScore.
  
  const SomeString = "foobar"
//      ^^^^^^^^^^ definition 0.1.test SomeString.
//      documentation ```go
...
//      ^^^^^^^^^^ definition 0.1.test LongString.
//      documentation ```go
  const ConstMath = 1 + (2+3)*5
//      ^^^^^^^^^ definition 0.1.test ConstMath.
//      documentation ```go
...
//      ^^^^^^^^^^^^^ definition 0.1.test AliasedString.
//      documentation ```go
