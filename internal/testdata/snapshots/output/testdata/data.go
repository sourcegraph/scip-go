...
//  > ```
     NestedA string
//   ^^^^^^^ definition 0.1.test `sg/testdata`/TestStruct#$anon_3d856ae3b9f10760#NestedA.
//   documentation
//   > ```go
//   > struct field NestedA string
//   > ```
     NestedB string
//   ^^^^^^^ definition 0.1.test `sg/testdata`/TestStruct#$anon_3d856ae3b9f10760#NestedB.
//   documentation
//   > ```go
...
//   > ```
     // NestedC docs
     NestedC string
//   ^^^^^^^ definition 0.1.test `sg/testdata`/TestStruct#$anon_3d856ae3b9f10760#NestedC.
//   documentation
//   > ```go
