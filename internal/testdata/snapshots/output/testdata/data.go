  package testdata
//        ^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/
//        documentation
//        > package testdata
...
//     ^^^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestInterface#
//     documentation
//     > ```go
//     > type TestInterface interface
//     > ```
...
// ^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestInterface#Do.
// documentation
// > ```go
...
//                                       ^^^^^ definition local 2
  ...
  type (
   ...
   TestStruct struct {
// ^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#
// documentation
// > ```go
...
// > ```
    // SimpleA docs
    SimpleA int
//  ^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#SimpleA.
//  documentation
//  > ```go
...
//  > ```
    // SimpleB docs
    SimpleB int
//  ^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#SimpleB.
//  documentation
//  > ```go
...
//  > ```
    // SimpleC docs
    SimpleC int
//  ^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#SimpleC.
//  documentation
//  > ```go
...
//  > ```
    ...
    FieldWithTag           string `json:"tag"`
//  ^^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#FieldWithTag.
//  documentation
//  > ```go
//  > struct field FieldWithTag string
//  > ```
    FieldWithAnonymousType struct {
//  ^^^^^^^^^^^^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#FieldWithAnonymousType.
//  documentation
//  > ```go
//  > struct field FieldWithAnonymousType struct{NestedA string; NestedB string; NestedC string}
//  > ```
     NestedA string
//   ^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#FieldWithAnonymousType.NestedA.
//   documentation
//   > ```go
//   > struct field NestedA string
//   > ```
     NestedB string
//   ^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#FieldWithAnonymousType.NestedB.
//   documentation
//   > ```go
...
//   > ```
     // NestedC docs
     NestedC string
//   ^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#FieldWithAnonymousType.NestedC.
//   documentation
//   > ```go
...
//   > ```
    ...
    EmptyStructField struct{}
//  ^^^^^^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#EmptyStructField.
//  documentation
//  > ```go
...
// ^^^^^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestEmptyStruct#
// documentation
// > ```go
...
//      ^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/Score.
//      documentation
//      > ```go
//      > const Score uint64 = 42
//      > ```
...
//      ^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/secretScore.
//      documentation
//      > ```go
//      > const secretScore uint64 = 43
//      > ```
//                    ^^^^^^ reference 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata/internal/secret`/
//                           ^^^^^^^^^^^ reference 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata/internal/secret`/SecretScore.
  
  const SomeString = "foobar"
//      ^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/SomeString.
//      documentation
//      > ```go
...
//      ^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/LongString.
//      documentation
//      > ```go
...
//      ^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/ConstMath.
//      documentation
//      > ```go
...
//     ^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/StringAlias#
//     documentation
//     > ```go
//     > string
//     > ```
...
//      ^^^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/AliasedString.
//      documentation
//      > ```go
//      > const AliasedString StringAlias = "foobar"
//      > ```
//                    ^^^^^^^^^^^ reference 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/StringAlias#
  
  // Doer is similar to the test interface (but not the same).
//⌄ enclosing_range_start 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#Doer().
  func (ts *TestStruct) Doer(ctx context.Context, data string) (score int, err error) {
//      ^^ definition local 3
//          ^^^^^^^^^^ reference 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#
//                      ^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#Doer().
//                      documentation
//                      > ```go
...
//                                                                         ^^^ definition local 7
   return Score, nil
//        ^^^^^ reference 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/Score.
  }
//⌃ enclosing_range_end 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestStruct#Doer().
...
//     ^^^^^^^^^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/StructTagRegression#
//     documentation
//     > ```go
//     > type StructTagRegression struct
//     > ```
...
//     > ```
   Value int `key:",range=[:}"`
// ^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/StructTagRegression#Value.
// documentation
// > ```go
...
//     ^^^^^^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestEqualsStruct#
//     documentation
//     > ```go
//     > type TestEqualsStruct = struct
//     > ```
...
//     > ```
   Value int
// ^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/TestEqualsStruct#Value.
// documentation
// > ```go
// > struct field Value int
// > ```
...
//     ^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/ShellStruct#
//     documentation
//     > ```go
//     > type ShellStruct struct
//     > ```
...
//     > ```
   ...
   // tests.
   InnerStruct
// ^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/ShellStruct#InnerStruct.
// documentation
// > ```go
// > struct field InnerStruct github.com/sourcegraph/scip-go/internal/testdata/testdata.InnerStruct
// > ```
// documentation
// > Ensure this field comes before the definition
// > so that we grab the correct one in our unit
// > tests.
// ^^^^^^^^^^^ reference 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/InnerStruct#
  }
  
  type InnerStruct struct{}
//     ^^^^^^^^^^^ definition 0.1.test `github.com/sourcegraph/scip-go/internal/testdata/testdata`/InnerStruct#
//     documentation
//     > ```go
//     > type InnerStruct struct
//     > ```
