...
//  ^^^^^^^ reference github.com/golang/go/src go1.21 context/
   "sync"
//  ^^^^ reference github.com/golang/go/src go1.21 sync/
  )
...
//     ^^ definition local 3
//        ^^^^ reference github.com/golang/go/src go1.21 sync/
//             ^^^^^^^^^ reference github.com/golang/go/src go1.21 sync/WaitGroup#
...
//                    ^^^ reference local 2
    wg.Add(1)
//  ^^ reference local 3
//     ^^^ reference github.com/golang/go/src go1.21 sync/WaitGroup#Add().
...
//              ^^^ reference local 1
     wg.Done()
//   ^^ reference local 3
//      ^^^^ reference github.com/golang/go/src go1.21 sync/WaitGroup#Done().
    }(fn)
//    ^^ reference local 5
   }
   ...
   wg.Wait()
// ^^ reference local 3
//    ^^^^ reference github.com/golang/go/src go1.21 sync/WaitGroup#Wait().
