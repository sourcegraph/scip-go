...
//        ^^^^^^^^ reference 0.1.test sg/testdata/
  ...
  import "io"
//        ^^ reference github.com/golang/go/src v1.19 io/
...
//     documentation ```go
//     documentation ```go
//     relationship github.com/golang/go/src v1.19 io/Closer# implementation
//     relationship 0.1.test sg/testdata/I3# implementation
   io.Closer
// ^^ reference github.com/golang/go/src v1.19 io/
//    ^^^^^^ definition 0.1.test sg/testdata/TClose#Closer.
//    documentation ```go
//    ^^^^^^ reference github.com/golang/go/src v1.19 io/Closer#
  }
